...
export class AppComponent {
  selecionado = null;
  disciplinas = [
    new Disciplina(1001, 'Língua Portuguesa', new Professor('Atauan S. de Queiroz'), 'O objetivo norteador da BNCC de Língua Portuguesa ' +
    ...
    new Disciplina(1002, 'Educação Física',new Professor('Fred P. Queiroga'),'A Educação Física é o componente curricular ' +
    ...
    new Disciplina(1003, 'Inglês',new Professor('Maria de Lourdes Marques Moraes'),'Aprender a língua inglesa propicia a criação de novas ' +
    ...
    new Disciplina(1004, 'Matemática', new Professor('Jean L. da Encarnação Coutinho'),'No Ensino Fundamental, essa área, por meio da ' +
    ...
    new Disciplina(1005, 'Ciências', new Professor('Paulo Correira/ Ana Célia'), 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
